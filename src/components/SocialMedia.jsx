...
function SocialMedia({className=""}) {
  ...
  return (
    <div className={`flex gap-3 mt-4 align-items-center ${className}`}>
       {socialMedia.map((item, index)=>(
        <a 
            key={index}
            href={item.link}
            target='_blank'
            className='hover:scale-120 duration-300 transition-transform bg-gray-100 p-2 rounded-full dark:bg-gray-700 dark:hover:fill-white dark:fill-gray-100'
        >{item.icon}</a>
       ))}
    </div>
  )
